...
const SidebarInset = React.forwardRef(({ className, ...props }, ref) => (
  <main
    ref={ref}
    className={cn(
      "relative flex min-h-svh flex-1 flex-col bg-background dark:bg-neutral-900",
...
const SidebarInput = React.forwardRef(({ className, ...props }, ref) => (
  <Input
    ref={ref}
    data-sidebar="input"
    className={cn("h-8 w-full bg-background dark:bg-neutral-900 shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring", className)}
    {...props}
  />
));
