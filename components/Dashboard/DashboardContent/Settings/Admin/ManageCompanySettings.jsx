...
import { Building2, Loader2, Save, Globe, DollarSign, Languages, Clock } from "lucide-react";
    ...
    <div className="max-w-full mx-auto p-4 lg:px-10 px-2 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Configure your organization's global settings and preferences</p>
        </div>
      </div>
      <Card className="border-2 shadow-md overflow-hidden dark:border-white/10">
        ...
        <CardHeader className="pb-4">
          ...
          <CardDescription>Basic company settings and regional preferences</CardDescription>
        </CardHeader>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  value={draft?.country ?? ""}
                  onChange={(e) => setDraft((o) => ({ ...o, country: e.target.value }))}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setDraft((o) => ({ ...o, currency: e.target.value }))}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setDraft((o) => ({ ...o, language: e.target.value }))}
      ...
      <Card className="border-2 shadow-md overflow-hidden dark:border-white/10">
        ...
        <CardHeader className="pb-4">
          ...
          <CardDescription>Configure default working hours and break deductions</CardDescription>
        </CardHeader>
            ...
            <>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  step="0.25"
                  value={draft?.defaultShiftHours === undefined || draft?.defaultShiftHours === null ? "" : draft.defaultShiftHours}
                  placeholder="8"
                  onChange={(e) =>
                    setDraft((o) => ({
                      ...o,
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  step="5"
                  value={draft?.minimumLunchMinutes === undefined || draft?.minimumLunchMinutes === null ? "" : draft.minimumLunchMinutes}
                  placeholder="60"
                  onChange={(e) =>
                    setDraft((o) => ({
                      ...o,
                ...
                />
                <p className="text-xs text-muted-foreground">
                  <strong>0</strong> or blank disables forced lunch deduction. Recommended default: <strong>60&nbsp;minutes</strong>.
                </p>
              </div>
            </>
          )}
