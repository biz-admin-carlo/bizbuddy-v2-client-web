          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <div className="flex justify-between text-xs">
                <span className="text-muted-foreground text-center w-full">{formProgress}%</span>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                {loadingApprovers ? (
                  <div className="flex items-center gap-2 text-sm text-neutral-500 p-3 border rounded-md">
                    ...
                    >
                      ...
                      <SelectContent className="max-h-60">
                        {approvers.length > 0 ? (
                          ...
                          <div className="p-2 text-sm text-neutral-500 text-center">No approvers available</div>
                        )}
                      </SelectContent>
                    </Select>
