...
export default function TemporaryPage() {
  ...
  const [features, setFeatures] = useState([
    { name: "Payroll", icon: <Calendar className="h-4 w-4" />, progress: 10 },
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-background to-orange-50/20 dark:from-background dark:to-orange-950/10">
      <div className="w-full max-w-3xl px-4">
        <div className="flex flex-col items-center text-center space-y-8 mb-8">
          <div className="relative">
            <div className="relative bg-orange-100 dark:bg-orange-950/30 p-6 rounded-full">
              <Construction className="h-24 w-24 text-orange-500 dark:text-orange-400" />
              <div
            ...
            <div className="absolute -top-2 -right-2">
              <div className="h-6 w-6 bg-yellow-400 dark:bg-yellow-600 rounded-full animate-pulse" />
            </div>
          </div>

          <div className="space-y-3">
            <Badge className="bg-orange-500 hover:bg-orange-500 dark:bg-orange-600 dark:hover:bg-orange-600 px-3 py-1 text-sm">Coming Soon</Badge>
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight bg-gradient-to-r from-orange-600 to-orange-400 dark:from-orange-500 dark:to-orange-300 bg-clip-text text-transparent">
              Under Construction
            </h1>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2 animate-pulse">Estimated completion: Coming soon</p>
        </div>
      </div>
    </div>
  );
